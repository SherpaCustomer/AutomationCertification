...
#pragma warning restore S1104 // Fields should not have public accessibility
        ...
        namespace Common
        {
            ...
            internal class Dms : Skyline.DataMiner.Library.Common.IDms
            {
                ...
                public int CreateView(Skyline.DataMiner.Library.Common.ViewConfiguration configuration)
                {
                    ...
                    try
                    {
                        Skyline.DataMiner.Net.Messages.Advanced.SetDataMinerInfoMessage message = Skyline.DataMiner.Library.Common.HelperClass.CreateAddOrUpdateMessage(configuration);
                        Skyline.DataMiner.Net.Messages.Advanced.SetDataMinerInfoResponseMessage response = (Skyline.DataMiner.Net.Messages.Advanced.SetDataMinerInfoResponseMessage)communication.SendSingleResponseMessage(message);
                ...
                public Skyline.DataMiner.Library.Common.IDmsView GetView(int viewId)
                {
                    if (viewId < -1)
                    {
                    ...
                    {
                        throw new Skyline.DataMiner.Library.Common.ViewNotFoundException(viewId);
                    }
            ...
            internal static class HelperClass
            {
                ...
                internal static Skyline.DataMiner.Net.Messages.Advanced.SetDataMinerInfoMessage CreateAddOrUpdateMessage(Skyline.DataMiner.Library.Common.ViewConfiguration viewConfiguration)
                {
                    Skyline.DataMiner.Net.Messages.Advanced.SetDataMinerInfoMessage message = new Skyline.DataMiner.Net.Messages.Advanced.SetDataMinerInfoMessage{Sa1 = new Skyline.DataMiner.Net.Messages.SA{Sa = new string[2]{viewConfiguration.Name, viewConfiguration.Parent.Id + System.String.Empty}}, What = 2};
                    return message;
                }
            ...
            public interface IDms
            {
                ...
                /// <exception cref = "IncorrectDataException"><paramref name = "configuration"/> is invalid.</exception>
                /// <returns>The ID of the created view.</returns>
                int CreateView(Skyline.DataMiner.Library.Common.ViewConfiguration configuration);
                /// <summary>
                ...
                /// <exception cref = "ViewNotFoundException">No view with the specified ID exists in the DataMiner System.</exception>
                /// <returns>The view with the specified ID.</returns>
                Skyline.DataMiner.Library.Common.IDmsView GetView(int viewId);
                /// <summary>
                ///     Retrieves the view with the specified name.
                /// </summary>
                /// <param name = "viewName">The view name.</param>
            ...
            {
                private Skyline.DataMiner.Library.Common.IDmsView parent;
                private string name;
                /// <summary>
                ...
                public ViewConfiguration(string name, Skyline.DataMiner.Library.Common.IDmsView parent)
                {
                    Name = name;
                    Parent = parent;
                }
                ...
                public string Name
                {
                    ...
                    set
                    {
                        name = Skyline.DataMiner.Library.Common.InputValidator.ValidateViewName(value, "value");
                    }
                }
                ...
                public override string ToString()
                {
                    ...
                    sb.AppendFormat(System.Globalization.CultureInfo.InvariantCulture, "Parent: {0}{1}", Parent, System.Environment.NewLine);
                    return sb.ToString();
                }
            }
            ...
            internal class DmsProtocol : Skyline.DataMiner.Library.Common.DmsObject, Skyline.DataMiner.Library.Common.IDmsProtocol
            {
                ...
                {
                    bool exists = false;
                    Skyline.DataMiner.Net.Messages.AlarmTemplateEventMessage response = GetAlarmTemplateSLNet(templateName);
                    if (response != null)
                    {
                        exists = true;
                    }
            ...
            internal class DmsView : Skyline.DataMiner.Library.Common.DmsObject, Skyline.DataMiner.Library.Common.IDmsView
            {
                ...
                public void Delete()
                {
                    Skyline.DataMiner.Net.Messages.Advanced.SetDataMinerInfoMessage message = new Skyline.DataMiner.Net.Messages.Advanced.SetDataMinerInfoMessage{DataMinerID = -1, ElementID = -1, IInfo1 = id, IInfo2 = -1, What = 4};
