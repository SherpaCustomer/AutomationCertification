namespace Skyline.DataMiner.Library.Common.Rates
{
	...
	public static class RateCalculator
	{
		...
		/// <returns>Array with the rates in units per second. Unit depends on provided arguments, e.g. when values are in octets and <paramref name="dataConversionType"/> is OctetsToBits then returned rate is bps.</returns>
